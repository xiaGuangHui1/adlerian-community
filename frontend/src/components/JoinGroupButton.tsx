  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-teal-500 text-white px-4 py-2.5 rounded-full shadow-md hover:bg-teal-600 hover:scale-105 transition-all flex items-center gap-2 cursor-pointer border-0"
        aria-label="Join community group"
      >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl shadow-xl w-full max-w-sm p-6 text-center">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-brown-900">Join Community Group</h3>
            ...
            <p className="text-sm text-gray-500 mb-4">Scan to add the developer on WeChat, and we'll invite you to the group</p>
            <img
            ...
            />
            <p className="text-xs text-gray-400 mt-4">Add "Adlerian Community" in the note</p>
          </div>
        </div>
      )}
    </>
